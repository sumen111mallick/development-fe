...
/* Code added by Radhika Start */
  ...
  product_insert_sale(details, id, amenityArray, furnishingArray,  product_img): Observable<any> {
    ...
    return this.http.post(AUTH_API + 'product/insert_product_sale', JSON.stringify ({
      ...
      area: details.Property_area.area,
      area_unit: details.Property_area.area_unit,
      carpet_area: details.Property_area.carpet_area,
      bedroom: details.Property_area.bedroom,
      bathroom: details.Property_area.bathroom,
      balconies: details.Property_area.balconies,
      additional_rooms: details.Property_area.additional_rooms,
      furnishing_status: details.Property_area.furnishing_status,
      furnishings: furnishingArray,
      total_floors: details.Property_area.total_floors,
      property_on_floor: details.Property_area.property_on_floor,
      rera_registration_status: details.Property_area.rera_registration_status,
      additional_parking_status: details.Property_area.additional_parking_status,
      equipment: details.Property_area.equipment,
      features: details.Property_area.features,
      nearby_places: details.Property_area.nearby_places,
      possession_by: details.Property_area.possession_by,
      facing_towards: details.Property_area.facing_towards,
      availability_condition: details.Property_area.availability_condition,
      buildyear: details.Property_area.buildyear,
      age_of_property: details.Property_area.age_of_property,
      parking_covered_count: details.Property_parking.parking_covered_count,
      parking_open_count: details.Property_parking.parking_open_count,
      sale_availability: 1,
      ownership: details.Property_Pricing.ownership,
      expected_pricing: details.Property_Pricing.expected_pricing,
      inclusive_pricing_details: details.Property_Pricing.inclusive_pricing_details,
      tax_govt_charge: details.Property_Pricing.tax_govt_charge,
      price_negotiable: details.Property_Pricing.price_negotiable,
      maintenance_charge_status: details.Property_Pricing.maintenance_charge_status,
      ...
      deposit: details.Property_Pricing.security_deposit,
      brokerage_charges: details.Property_Pricing.brokerage_charges,
      inc_electricity_and_water_bill:details.Property_Pricing.inc_electricity_and_water_bill,
      amenities: amenityArray,
      description: details.Property_descption.description,
    }), httpOptions);
  }
  ...
  product_insert_rent(details, id, amenityArray, furnishingArray,  product_img,): Observable<any> {
    return this.http.post(AUTH_API + 'product/insert_product_rent', JSON.stringify ({
      ...
      rent_availability: 1,
      ownership: details.Property_Pricing.ownership,
      expected_rent: details.Property_Pricing.expected_rent,
      inclusive_pricing_details: details.Property_Pricing.inclusive_pricing_details,
      tax_govt_charge: details.Property_Pricing.tax_govt_charge,
      price_negotiable: details.Property_Pricing.price_negotiable,
      maintenance_charge_status: details.Property_Pricing.maintenance_charge_status,
      maintenance_charge: details.Property_Pricing.maintenance_charge,
      maintenance_charge_condition: details.Property_Pricing.maintenance_charge_condition,
      security_deposit: details.Property_Pricing.security_deposit,
      agreement_type: details.Property_Rent_Condition.agreement_type,
      available_for: details.Property_Rent_Condition.available_for,
      duration_of_rent_aggreement: details.Property_Rent_Condition.duration_of_rent_aggreement,
      month_of_notice: details.Property_Rent_Condition.month_of_notice,
      rent_cond: details.Property_Rent_Condition.rent_cond,
      willing_to_rent_out_to: details.Property_Rent_Condition.willing_to_rent_out_to,
      brokerage_charges: details.Property_Pricing.brokerage_charges,
      inc_electricity_and_water_bill:details.Property_Pricing.inc_electricity_and_water_bill,
      amenities: amenityArray,
      description: details.Property_descption.description,
